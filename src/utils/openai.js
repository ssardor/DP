const API_KEY = process.env.REACT_APP_OPENAI_API_KEY; // Ваш API ключ OpenAI
const API_URL = "https://api.intelligence.io.solutions/api/v1/chat/completions"; // URL API OpenAI
